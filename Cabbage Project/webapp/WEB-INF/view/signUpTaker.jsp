    ...
    <form action="/taker/signUp" method="post"><!--//form start-->
        <div id="signUpInputContent"><!--sign_up_input_container start-->
            ...
            <div class="birthday_input_box"><!--birthdayInputBox start-->
                ...
                <input class="birth_date_input" name="birthDay" maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" /><div class="birth_date_title"><p>일</p></div>
            ...
            <div class="profile_img_input_box"><!--profileImg_input_box start-->
                ...
                <label class="profile_img_input" for="profileImgInput"><i class="far fa-plus-square plusBtn"></i></label>
                <!--input value를 기본프로필로 넘길 사진으로 해두면 된다.-->
                <input id="profileImgInput" name="profileImg" type="file" accept="image/*" value=""/>
...
const $profilePlusBtn = $(".plusBtn");
const $profileCancleBtn = $(".delete");
...
$profileImgInput.on("change", function(){
    ...
    if (/^image\//.test(file.type)) {
        ...
        success:function(json) {
            $profileImg.css("background-image","url(../../img/upload/"+json.profileName+")");
            $profileImgInput.val(json.profileName);
            $profilePlusBtn.css("display","none");
        }
    });
    } else {
        alert("이미지를 선택해주세요!");
...
$profileCancleBtn.click(function(){
    ...
    $profilePlusBtn.css("display","block");
