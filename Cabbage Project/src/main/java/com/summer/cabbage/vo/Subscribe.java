...
public class Subscribe {
	...
	//03-04오승주 추가 end
	//0312필드 추가
	private int reviewOnOff;
	//0311 추가
	private Date thisPayment;
	...
	public int getReviewOnOff() {
		return reviewOnOff;
	}

	public void setReviewOnOff(int reviewOnOff) {
		this.reviewOnOff = reviewOnOff;
	}

	//0311 추가
	public Date getThisPayment() {
		
		return thisPayment;
	}

	public void setThisPayment(Date thisPayment) {
