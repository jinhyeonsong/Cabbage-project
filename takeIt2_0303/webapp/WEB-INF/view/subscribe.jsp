        ...
        <form id="subscribeForm" action="/subscribe" method="POST">
            <div>
                        ...
                        <div class="item_info_box">
                            ...
                            <dl>
                                ...
                                <dd class="opt_area">
                                    ...
                                    <input id="deliveryAddrOption${opt.no}" name="deliveryAddrOption" value="${opt.primaryRegionName}${opt.regionName}" class="addr_option_input" type="radio" <c:if test="${opt.no eq param.regionNo}"> checked</c:if>>
                                    <label class="delivery_opt_label" for="deliveryAddrOption${opt.no }" data-price="${opt.price+product.price}" data-sido="${opt.primaryRegionName}" data-sigungu="${opt.regionName}">${opt.primaryRegionName}${opt.regionName}/+<span class="opt_price">${opt.price}</span></label>
                                    <input type="hidden" class="opt_price_input" name="deliveryOptPrice" value="${opt.price}" />
                                    </c:forEach>
                                </dd>
                            </dl>
                            <dl class="price_tag">
                ...
                <div class="taker_msg_content">
                    ...
                    <div class="form_wrap">
                        <textarea name="takerTxt" class="taker_textarea"></textarea>
        ...
        <div id="paymentPopPage">
            ...
            <div id="paymentPopContainer">
                ...
                <div class="card_cvc_area">
                    ...
                    <input id="cardCVC" class="card_digit" name="cardCVC" maxlength="3" placeholder="000" />
                </div>
                <div class="msg_area">
