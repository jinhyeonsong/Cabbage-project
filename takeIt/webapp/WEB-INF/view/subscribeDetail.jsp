            ...
            <div class="product_detail_page_content_head">
                <div class="item_category_box">
                    <div class="category_box">
                        <p><span class="category"><a href="">${ product.primaryCategoryName}</a></span> > <span><a href=""> ${product.categoryName}</a></span></p>
                    </div>
                ...
                <div class="giver_information_box">
                    <div class="giver_information">
                        ...
                        <a href="/giver/${giver.no }/info"><img class="giver_profile_img" src="/img/${giver.profileImg }"></a>
                        <a href="/giver/${giver.no }/info"><span>${giver.company }</span></a>
                    </div>
                </div>
            </div>
